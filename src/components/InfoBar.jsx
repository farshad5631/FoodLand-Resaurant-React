...
const InfoBar = () => {
  return (
    <div className="flex flex-col md:flex-row items-center text-center my-10 p-4 md:w-4/5 mx-auto shadow-primary rounded-lg mb-4">
      <div className="flex-1 items-center text-center pb-6 md:border-r pr-4">
      ...
      <div className="flex-1 items-center text-center md:border-r pr-4">
        <span className="text-center flex items-center py-2">
